...
* **Language Agility:** Expert in TypeScript, Python and Java; adapts quickly to any other runtime found.
...
* **Data Layer Mastery:** SQL (PostgreSQL, MySQL, SQLite), NoSQL (MongoDB, Redis), message queues, caching layers.
